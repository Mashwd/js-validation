...
<body style="background: #F3F3F3;">
	...
	<div style="display: grid; place-items: center center"> 
		<form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="POST" autocomplete = 'on' name="registrationForm" onsubmit="return isValid()">
			<fieldset>
				...
				<span style="color: red;" id="firstname"><?php echo $firstNameErr; ?></span>
				<br><br>

				<label for="lastname">Last Name <span style="color: red;">*</span>: </label>
				<input type="text" name="lastname" value="<?php echo $lastName; ?>">
				<span style="color: red;" id="lastname"><?php echo $lastNameErr; ?></span>
			    ...
			    <span style="color: red;" id="birthday"><?php echo $birthdayErr; ?></span>

			    <br><br>

			    <label for="religion">Religion<span style="color: red;">*</span>:</label>
			    <select name="religion" value ="<?php echo $religion; ?>">
			    ...
			    <span style="color: red;" id="religion"><?php echo $religionErr; ?></span>
			</fieldset>
		    ...
		    <legend>Contact Information:</legend>
			    ...
			    <span style="color: red;" id="email"><?php echo $emailErr.$emailMsg; ?></span>
		  ...
		  <fieldset>
		  	<legend>Account Information</legend>
				...
				<span style="color: red;" id="username"><?php echo $userNameErr; ?></span>
				...
				<span style="color: red;" id="password"><?php echo $passwordErr . $passMsg; ?></span>
	...
	<script>
		function isValid(){
			var flag = true;
			var firstNameErr = document.getElementById("firstname");
			var firstName = document.forms["registrationForm"]["firstname"].value;
			firstNameErr.innerHTML = "";

			var lastNameErr = document.getElementById("lastname");
			var lastName = document.forms["registrationForm"]["lastname"].value;
			lastNameErr.innerHTML = "";

			var genderErr = document.getElementById("gender");
			genderErr.innerHTML = "";

			var birthdayErr = document.getElementById("birthday");
			var birthday = document.forms["registrationForm"]["birthday"].value;
			birthdayErr.innerHTML = "";

			var religionErr = document.getElementById("religion");
			...
			if(birthday === "")
			{
				birthdayErr.innerHTML = "Birthday can not be empty!";
				flag = false;
			}
			if(religion === "")
			{
